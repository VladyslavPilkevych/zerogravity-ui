...
export const APERTURE_CONTROLS: ControlGroup[] = [
    {
        ...
        open: true,
        controls: [
            { kind: "cssLength", path: "height", label: "Scroll length", min: 100, max: 320, step: 10, unit: "vh" },
            { kind: "number", path: "inset", label: "Inset", min: 0, max: 40, step: 0.5, unit: "%" },
            { kind: "number", path: "radius", label: "Corner radius", min: 0, max: 80, step: 2, unit: "px" },
    ...
    },
    {
        ...
        open: true,
        controls: [
            { kind: "number", path: "scale", label: "Content pull-back", min: 0, max: 0.3, step: 0.01 },
